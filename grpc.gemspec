...
Gem::Specification.new do |s|
  ...
  s.files += %w( src/core/lib/iomgr/inproc_address.h )
  ...
  s.files += %w( src/core/ext/transport/inproc/inproc_client_server.h )
  ...
  s.files += %w( src/core/lib/iomgr/inproc_address.c )
  ...
  s.files += %w( src/core/ext/transport/inproc/inproc_client_server.c )
